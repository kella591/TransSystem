...
<body>
	...
	<div class="container-fluid" ng-controller="docListController">
		...
		<tr ng-repeat="doc in docList">
			...
			<td><a href="./viewBidTraderList.jsp?docid={{doc.id}}" ng-bind="'TransportDetail'|translate">竞标商详情</a>
			</td>
			<td ng-if="doc.state==='GOING'"><a href="./timeLine.jsp?docid={{doc.id}}">时间轴</a></td>
		</tr>
		</tbody>
		</table>
